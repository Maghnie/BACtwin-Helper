...
const COLUMN_COLORS = {
  ...
  Description: "#FFCC00",
  Location: "#FFCC00",
  Protocol_Version: "#FFCC00",
  Protocol_Revision: "#FFCC00",
  Protocol_Services_Supported: "#FFCC00",
  Protocol_Object_Types_Supported: "#FFCC00",
  Local_Time: "#FFCC00",
  Local_Date: "#FFCC00",
  UTC_Offset: "#FFCC00",
  Time_Synchronization_Recipients: "#FFCC00",
  UTC_Time_Synchronization_Recipients: "#FFCC00",
  Time_Synchronization_Interval: "#FFCC00",
  Align_Intervals: "#FFCC00",
  Interval_Offset: "#FFCC00",
  Max_Master: "#33CCCC",
  Max_Info_Frames: "#33CCCC",
};
...
export default function DEV() {
  ...
  const loadData = async () => {
    try {
      const res = await axios.get(`${API_URL}/dev`);
      setItems(res.data || []);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/dev`, payload);
