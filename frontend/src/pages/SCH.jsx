...
const COLUMN_COLORS = {
  Object_Name: "#FFCC00",
  Description: "#FFCC00",
  Weekly_Schedule: "#FFCC00",
  Exception_Schedule: "#FFCC00",
  Schedule_Default: "#FFCC00",
  List_Of_Object_Property_References: "#FFCC00",
...
export default function SCH() {
  ...
  const loadData = async () => {
    try {
      const res = await axios.get(`${API_URL}/sch`);
      setItems(res.data || []);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/sch`, payload);
