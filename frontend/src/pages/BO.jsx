...
// 🎨 Spaltenfarben (orange/türkis wie bei den anderen Templates)
const COLUMN_COLORS = {
  // Eingabe-/Parameter-orientiert (orange)
  Object_Name: "#FFCC00",
  Description: "#FFCC00",
  Inactive_Text: "#FFCC00",
  Active_Text: "#FFCC00",
  Polarity: "#FFCC00",
  Minimum_Off_Time: "#FFCC00",
  Minimum_On_Time: "#FFCC00",
  ...
  // Status-/Zustands-orientiert (türkis)
  Status_Flags: "#33CCCC",
  Event_State: "#33CCCC",
  Reliability: "#33CCCC",
  Change_Of_State_Count: "#33CCCC",
  Elapsed_Active_Time: "#33CCCC",
  Out_Of_Service: "#33CCCC",
  Event_Time_Stamps: "#33CCCC",
  Event_Message_Texts: "#33CCCC",
  Feedback_Value: "#33CCCC",
...
export default function BO() {
  ...
  const loadData = async () => {
    try {
      const res = await axios.get(`${API_URL}/bo`);
      setItems(res.data || []);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/bo`, payload);
