...
// 🎨 Spaltenfarben (orange = Konfiguration / Parameter, türkis = Status)
const COLUMN_COLORS = {
  Object_Name: "#FFCC00",
  Description: "#FFCC00",
  Enable: "#FFCC00",
  Log_DeviceObjectProperty: "#FFCC00",
  Log_Interval: "#FFCC00",
  COV_Resubscription_Interval4: "#FFCC00",
  Client_COV_Increment: "#FFCC00",
  Stop_When_Full: "#FFCC00",
  Buffer_Size: "#FFCC00",
  Logging_Type: "#FFCC00",
  Trigger: "#FFCC00",
  Notification_Threshold: "#FFCC00",
...
export default function TL() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_URL}/tl`, payload);
